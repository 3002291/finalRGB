...
@DzModel(name = "Ehsevr00700", desc = "자동측정항목등록", tableName = "")
public class Ehsevr00700 extends DzAbstractModel {
	...
	@DzModelField(name="plant_nm", desc="사업장명", colName="PLANT_NM", colSize="7", isKey=false)
	...
	@SerializedName("ORG_MESR_CLAS_CD")
	@DzModelField(name="org_mesr_clas_cd", desc="측정항목코드", colName="ORG_MESR_CLAS_CD", colSize="20", isKey=false)
	private String org_mesr_clas_cd;
	...
	public String getOrg_mesr_clas_cd() {
		return org_mesr_clas_cd;
	}

	public void setOrg_mesr_clas_cd(String org_mesr_clas_cd) {
		this.org_mesr_clas_cd = org_mesr_clas_cd;
	}
